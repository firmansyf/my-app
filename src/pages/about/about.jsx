...
export function About() {
  ...
  return (
    <div className='my-14 w-full flex max-w-screen-lg flex-col gap-8'>
      <Card className='p-3'>
        ...
        <CardBody className='p-4'>
          ...
          <Typography variant='h6' className='tracking-wide font-normal mt-3 leading-relaxed'>
            ...
            well-versed in Project Management methods like Waterfall and Agile. {"I'm"} particularly
            passionate about frontend side, where I focus on creating web applications that are not
            only precise but also user-friendly experiences.
          </Typography>
          <Typography variant='h6' className='tracking-wide font-normal mt-3 leading-relaxed'>
            I specialize in JavaScript, also {"it's"} frameworks, including React (Next.js, Vite). I
            love exploring new web technologies and features.
          </Typography>
          <Typography variant='h6' className='tracking-wide font-normal mt-3 leading-relaxed'>
