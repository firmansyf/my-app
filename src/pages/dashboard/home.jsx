...
import {statisticsChartsData, projectsTableData, ordersOverviewData} from '@/dataDummy'
      ...
      <div className='mb-10 grid gap-y-10 gap-x-6 md:grid-cols-1 xl:grid-cols-1 '>
        <Card>
          <CardBody>
            ...
            Seasoned Software Engineer especially in Frontend side, with a passion for creating
            pixel-perfect web experiences. I work with JavaScript and specialize in all-things web.
            I thrive on collaborating with teams to deliver efficient, scalable, and visually
      ...
      <div className='mb-4 grid grid-cols-1 gap-6 xl:grid-cols-3'>
        ...
        <Card className='border border-blue-gray-100 shadow-sm'>
          ...
          <CardBody className='pt-0'>
            {ordersOverviewData?.map(({icon, color, title, description, position}, key) => (
